...
export interface Session {
  step?: "listing_title" | "listing_description" | "listing_photos" | "listing_price" | "listing_quantity" | "withdraw_address" | "dispute_claim" | "dispute_evidence";
  draftListing?: {
    title?: string;
    description?: string;
    photos?: string[];
